...
int main()
{
    ...
    std::cout << "Substraction Result : " << result << std::endl;
    // Multiplication
    result = number1 * number2;
    ...
    double dresult = number2 / number1;
    std::cout << "Division double Result : " << dresult << std::endl;

    double dnumber1{2};
    double dnumber2{7};

    dresult = dnumber2 / dnumber1;
    std::cout << "Division double Result with double variables: " << dresult << std::endl;
    // for the division to be exact the result variable and all the numbers involved sould be declared as fractional
    // Modulus
    result = number2 % number1;
