...
int main()
{
    // std::endl : places new line new line character on the output stream.
    ...
    // has been sent to the stream. This may be important in some cases.
    ...
    std::cout << "a (precision(7)) : " << a << std::endl;
